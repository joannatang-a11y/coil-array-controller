def run gui():
    root = tk.Tk()
    root.title("Magnetic Sites Sequencer (32) — Single & Dual Modes (2-coil split)")
    ...
    nb.add(single_tab.frame, text="Single Fluid (travel + 2-coil split + append)")
    nb.add(dual_tab.frame, text="Dual Fluid (2 pathways, 2-per-path)")
